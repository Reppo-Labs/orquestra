...
const ClaimSchema = z.object({
  claims: z.array(z.object({
    ...
    // Short pod-name headline. Optional + generous max so a model overrun degrades
    // to the clamp below instead of failing schema validation and dropping the batch.
