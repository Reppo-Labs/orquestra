 ...
 *  mint prompts must never render it (enforced at the mint screen boundary in
 *  wiring.ts, which strips currentYield)). Built from NUMERICS ONLY — the native-token symbol
