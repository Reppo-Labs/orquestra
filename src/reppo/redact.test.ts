...
describe('redactSecrets', () => {
  ...
  it('redacts alchemy-style key paths even without the flag form', () => {
    const out = redactSecrets('rpc error from https://base-mainnet.g.alchemy.com/v2/abcDEF123xyz: timeout')
    expect(out).not.toContain('abcDEF123xyz')
    expect(out).toContain('alchemy.com/v2/<redacted>')
  })
